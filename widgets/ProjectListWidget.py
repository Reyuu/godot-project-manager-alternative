...
class Ui_widgetMain(object):
    def setupUi(self, widgetMain):
        ...
        icon1 = QIcon()
        icon1.addFile("icons/star.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, widgetMain):
        widgetMain.setWindowTitle(QCoreApplication.translate("widgetMain", "Form", None))
        self.favButton.setText("")
        self.icon.setText(QCoreApplication.translate("widgetMain", "Image", None))
        self.projectNameLabel.setText(
            QCoreApplication.translate("widgetMain", "Project name", None)
        )
