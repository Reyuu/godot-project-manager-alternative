...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile("icons/file-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionNew_from_template.setIcon(icon)
        self.actionRemove_selected_project = QAction(MainWindow)
        self.actionRemove_selected_project.setObjectName("actionRemove_selected_project")
        icon1 = QIcon()
        icon1.addFile("icons/file-minus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRemove_selected_project.setIcon(icon1)
        self.actionRename_selected_project = QAction(MainWindow)
        self.actionRename_selected_project.setObjectName("actionRename_selected_project")
        icon2 = QIcon()
        icon2.addFile("icons/edit-3.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRename_selected_project.setIcon(icon2)
        self.actionExit = QAction(MainWindow)
        self.actionExit.setObjectName("actionExit")
        icon3 = QIcon()
        icon3.addFile("icons/x-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.projectsListView.setStyleSheet("")
        ...
        icon4 = QIcon()
        icon4.addFile("icons/plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.renameCategoryButton.setObjectName("renameCategoryButton")
        ...
        icon5 = QIcon()
        icon5.addFile("icons/minus.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNew_from_template.setText(
            QCoreApplication.translate("MainWindow", "New from template", None)
        )
        self.actionRemove_selected_project.setText(
            QCoreApplication.translate("MainWindow", "Remove selected project", None)
        )
        self.actionRename_selected_project.setText(
            QCoreApplication.translate("MainWindow", "Rename selected project", None)
        )
        self.actionExit.setText(QCoreApplication.translate("MainWindow", "Exit", None))
        self.categoriesLabel.setText(QCoreApplication.translate("MainWindow", "Categories", None))
        self.addCategoryButton.setText(QCoreApplication.translate("MainWindow", "Add", None))
        self.renameCategoryButton.setText(QCoreApplication.translate("MainWindow", "Rename", None))
        self.removeCategoryButton.setText(QCoreApplication.translate("MainWindow", "Remove", None))
